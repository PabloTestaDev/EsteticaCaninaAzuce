...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        control.modificarMascota(masco, nombreMasco,raza,colorPelaje,alergias,observaciones,nombreTutor,contacto,alergico,especial);
    ...
    private void cargarDatos(int numCliente) {
        ...
        txtNombre1.setText(masco.getTutor().getNombreTutor());
        txtNombre2.setText(masco.getNombre());
        txtRaza.setText(masco.getRaza());
        txtColorPelaje.setText(masco.getColor());
        txtAlergias.setText(masco.getAlergico());
        txtContacto.setText(masco.getTutor().getCelTutor());
        txtObservaciones.setText(masco.getObservaciones());
        
        if (masco.getAlergico().equals("Si")) {
            cmbAlergias.setSelectedIndex(1);
        } else if (masco.getAlergico().equals("No")) {
            cmbAlergias.setSelectedIndex(2);
        }
        
        if (masco.getAtenEspe().equals("Si")) {
            cmbAtEsp.setSelectedIndex(1);
        } else if (masco.getAtenEspe().equals("No")) {
